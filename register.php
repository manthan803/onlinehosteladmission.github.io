...
<html lang="en">
  <head>
    ...
    <title>Hostel Register System</title>


    <style>
    
          body{
             background-image: url('images/back_login6.jpg');
          }         
         
          #back{
             border: 3px inset rgb(66, 61, 58);
          }
  ...
  <a class="navbar-brand" href="#"><u>Register System</u></a>
...
<h3 style="padding:20px; margin:5px; font-size:40px; text-shadow:2px 2px 2px blue"><u><marquee>Please Register Here :</marquee></u></h3>
<hr>
...
<div>
          ...
          <p id="wlcome"><img src=" images/welcome1.jpg" height="150px" width="500px"></p>
