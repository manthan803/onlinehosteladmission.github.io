...
<html lang="en">
  <head>
    ...
    <title>Hostel Login System</title>

    <style>

          body{
              background-image:url("images/back_login4.jpg");
              
          }
          
          #back{
              border: 3px outset rgb(29, 20, 20);
          }
  ...
  <a class="navbar-brand" href="#"><u>Login page</u></a>
  ...
  <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="procedure.php"><b>Procedure</b><span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
...
<div class="container mt-4 " id="back">
        <h3 style="padding:20px; margin:5px; font-size:40px; text-shadow:2px 2px 2px blue"><u><marquee>Please Login Here :</marquee></u></h3>
        <hr>
...
<div>
          ...
          <p id="wlcome"><img src=" images/welcome.jpg" height="150px" width="500px"></p>
